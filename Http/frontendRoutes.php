...
$router->group(['prefix' => 'auth'], function (Router $router) {
    # Login
    $router->get('login', ['middleware' => 'auth.guest', 'as' => 'login', 'uses' => 'AuthController@getLogin'])->middleware('nocache');
    ...
    # Logout
    $router->get('logout', ['as' => 'logout', 'uses' => 'AuthController@getLogout'])->middleware('nocache');
});
